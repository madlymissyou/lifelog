...
* `2019-10-25` **트레바리 이벤트** 사피엔스와 AI `(트레바리 이벤트 @현대모터스튜디오 서울)`
* `2019-11-06` 사피엔스와 AI `(광의료심포지엄 @광주 라마다호텔)`
* `2019-11-08` **트레바리 클럽 '내 인생의 조각모음'** 1회차 `(트레바리 @강남아지트)`
...
* `2019-12-13` **트레바리 클럽 '내 인생의 조각모음' 2회차** `(트레바리 @강남아지트)`
* `2019-12-18` **트레바리 이벤트** '내 인생의 조각모음' `(트레바리 @강남아지트)` [[공지]][https://trevari.co.kr/events/show?eventID=852cc43e-6eb3-4708-9dad-7d59184e6ee7]
