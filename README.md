...
## TV
* `2016-03-11` **KBS스페셜** '인공지능, 인간을 이기다' [[다시보기]](http://vod.kbs.co.kr/index.html?source=episode&sname=vod&stype=vod&program_code=T2016-0065&program_id=PS-2016033337-01-000&section_code=05&broadcast_complete_yn=Y&local_station_code=00&fbclid=IwAR1KjQw0lqDGq_MTH7fYsC3IggAR6isFDE4tpNoK5bOIAIbIsINRO_Wo9iQ)

## 라디오
* `2014-04-03` KBS대전라디오 인생이 빛나는 마법의 정리
* `2014-05-01` KBS대전라디오 모리와 함께 한 화요일
* `2014-05-22` KBS대전라디오 행복의 가격
* `2014-06-12` KBS대전라디오 요람 속의 과학자
* `2014-07-03` KBS대전라디오 르네상스 미술이야기
* `2014-07-31` KBS대전라디오 서재 결혼시키기
...
* `2018-11-04` 인공지능의 강화학습 `HelloDD` [[html]](https://hellodd.com/?md=news&mt=pop_print&pid=66561)
...
* `2015-07-28` **백북스** <통찰의 시대> `(대전백북스/과학예술포럼 @백북스홀)`
...
* `2018-11-02` 강화학습이란 무엇인가 `(새통사)` [[기사]](https://hellodd.com/?md=news&mt=pop_print&pid=66561)
...
* `2019-06-17` 호모 사피엔스와 AI `(한예종)` [[info]](https://www.karts.ac.kr/nri/bbs/NuriBbsDetail.do?pageIndex=1&bbsId=BBSNURI_001&nttNo=9883393)
* `2019-07-06` 호모 AI 사피엔스 `(AI Festival @KAIST 문지캠퍼스)`
* `2019-07-22` 사피엔스와 AI `(KAIST 과학영재교육연구원 여름캠프 1차 @KAIST)`
* `2019-07-25` 사피엔스와 AI `(KAIST 과학영재교육연구원 여름캠프 2차 @KAIST)`
* `2019-07-22` **알파고는 스스로 신의 경지에 올랐다** `(유성다과상 @유성청소년수련원)`
* `2019-08-05` 과학과 예술 `(전국교육장워크숍 @울산현대호텔)`
* `2019-08-13` 마이티 프로젝트 `(KAIST STEAM 교사 심화연수 @ETRI)`
* `2019-08-14` 호모사피엔스와 AI `(조찬포럼 굿모닝사이언스 @TBC)`
* `2019-08-14` 강화학습 번역 후기 `(AI프렌즈 @TBC)`
* `2019-09-03` 알파고 이후의 인공지능 `(삼양사)`
* `2019-09-05` 사피엔스와 AI `(비파괴검사 워크숍 @정읍)`
* `2019-09-09` 사진 찍는 법 핸즈온 톡 `(ETRI 톡서클럽)`
* `2019-10-16` 생각의 기원과 교육의 미래 `(원묵중학교 교사연수)`
* `2019-10-17` 사피엔스와 AI `(ETRI 신입직원 교육)`
* `2019-10-19` 사피엔스와 AI `(사이언스 페스티블 @대전 엑스포광장 무빙셸터 메인무대)`
* `2019-10-22` 사피엔스와 AI `(백북스 @대전 백북스홀)`
* `2019-10-25` **트레바리 이벤트** 사피엔스와 AI `(트레바리 이벤트 @현대모터스튜디오 서울)` [[info]](https://trevari.co.kr/events/show?eventID=4c0d7e7e-3e5a-430a-b824-05143cd3c835)
* `2019-11-06` 사피엔스와 AI `(광의료심포지엄 @광주 라마다호텔)` [[press]](http://www.bosa.co.kr/news/articleView.html?idxno=2114812)[[press]](http://www.bosa.co.kr/news/articleView.html?idxno=2115557)
* `2019-11-08` **트레바리 클럽** '내 인생의 조각모음' S1E01 `(트레바리 @강남아지트)` [[info]](https://trevari.co.kr/meetings/show?clubID=bbcfd9a0-44e4-40dc-aecf-a56e95098261&order=1)
* `2019-11-13` 사피엔스와 AI `(국경관리연수원)`
* `2019-11-13` **강화학습 튜토리얼: 서튼 책 씹어먹고 그린 랜드스케이프** `(AI프렌즈 @TBC 콜라보홀)` [[기사]](https://hellodd.com/?md=news&mt=view&pid=70295)
...
* `2019-12-13` **트레바리 클럽** '내 인생의 조각모음' S1E02 `(트레바리 @강남아지트)` [[info]](https://trevari.co.kr/meetings/show?clubID=bbcfd9a0-44e4-40dc-aecf-a56e95098261&order=2)
...
#### 2020년
* `2020-01-08` 사피엔스와 AI `(AI프렌즈)`
* `2020-01-10` **트레바리 클럽** '내 인생의 조각모음' S1E03 `(트레바리 @강남아지트)`
* `2020-01-16` **트레바리** 파트너 오리엔테이션 'AI 입문' 1차 `(트레바리 @강남아지트)`
* `2020-01-17` **트레바리** 파트너 오리엔테이션 'AI 입문' 2차 `(트레바리 @강남아지트)`
* `2020-01-18` **트레바리 클럽 '국경' <생각의 기원>** `(트레바리 @강남아지트)`
* `2020-05-01` **트레바리 클럽** '내 인생의 조각모음' S1E04 `(트레바리 @강남아지트)`
* `2020-05-08` **트레바리 클럽** '내 인생의 조각모음' S2E01 `(트레바리 @강남아지트)`
* `2020-05-29` 커뮤니티가 답이다 `(학습연구년 교사 연수 @목원대학교)`
* `2020-06-03` 사피엔스와 AI `(미래예측연구회)`
* `2020-06-12` **트레바리 클럽** '내 인생의 조각모음' S2E02 `(트레바리 @강남아지트)`
* `2020-06-18` 사진에 대하여 `(ETRI톡서클럽)`
* `2020-06-26` 사피엔스와 AI `(을지대학교 의과대학 MIT 수업 @ZOOM)`
* `2020-07-10` **트레바리 클럽** '내 인생의 조각모음' S2E03 `(트레바리 @강남아지트)`
* `2020-08-14` **트레바리 클럽** '내 인생의 조각모음' S2E04 `(트레바리 @강남아지트)`
* `2020-09-07` 4차산업혁명 신기술 `(국경관리연수원 @온라인)`
* `2020-09-24` 사피엔스와 AI `(부산대학교 의생명공학과 @ZOOM)`
* `2020-10-09` **트레바리 클럽** '내 인생의 조각모음' S3E01 `(트레바리 @강남아지트)`
...
* 공연
  ...
  * `2004.10.05` Moulin Rouge (파리)
  * `2004.10.06` Sunside (파리)
  * `2004.10.07` New Morning (파리)
  ...
  * `2005.06.21` 사이먼 래틀 (베를린필하모닉홀, 베를린)
  ...
  * `2011.05.07` Maison de Jazz (몬트리올)
  * `2011.05.09` Maison de Jazz (몬트리올)
  * `2011.05.10` Jazz Club (몬트리올)
  * `2011.05.10` Upstairs (몬트리올)
  * `2011.05.13` Upstairs (몬트리올)
  * `2011.08.14` **비발디 사계** (산 바소 성당, 베네치아)
  * `2012.07` 지산밸리록페 **라디오헤드** (1일권 14만원)
  * `2012.08` 현대카드 슈퍼콘서트 **에미넴** (잠실종합운동장 보조경기장)
  * `2013.08.17` 현대카드 슈퍼콘서트 **Limp Bizkit/Muse** (잠실종합운동장)
  * `2013.10.12` 도시락콘서트 (마암리)
...
* 전시
  * `2005` ... 독일
  * ...
  * `2008.06.26` 피카소 미술관 (바르셀로나)
  * `2008.06.28` 카탈루냐 미술관 (바르셀로나)
  * `2008.06.28` 호안 미로 미술관 (바르셀로나)
  * `2008.07.02` 프라도 미술관 (마드리드)
  * ...
  * `2012.07` 제체시온 (빈)
  * `2012.07` MQ 레오폴트 뮤지엄 (빈)
  * `2012.07` 빈미술사박물관 (빈)
  * `2014.02` 게티 센터 (LA)
